...
int dev_pm_qos_add_notifier(struct device *dev, struct notifier_block *notifier)
{
	...
	if (!ret)
		ret = srcu_notifier_chain_register(dev->power.qos->resume_latency.notifiers, notifier);
			       ...
			       struct notifier_block *notifier)
{
	...
	if (!IS_ERR_OR_NULL(dev->power.qos))
		retval = srcu_notifier_chain_unregister(dev->power.qos->resume_latency.notifiers, notifier);
