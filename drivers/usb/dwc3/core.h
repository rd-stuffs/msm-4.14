...
/* Global RX/TX Threshold Configuration Register for DWC_usb31 only */
#define DWC31_GRXTHRCFG_MAXRXBURSTSIZE(n)	(((n) & 0x1f) << 16)
#define DWC31_GRXTHRCFG_RXPKTCNT(n)		(((n) & 0x1f) << 21)
#define DWC31_GRXTHRCFG_PKTCNTSEL		BIT(26)
#define DWC31_RXTHRNUMPKTSEL_PRD		BIT(29)
#define DWC31_RXTHRNUMPKT_PRD(n)		(((n) & 0x1f) << 24)
#define DWC31_MAXRXBURSTSIZE_PRD(n)		(((n) & 0x1f) << 19)
...
#define DWC31_TXTHRNUMPKTSEL_PRD		BIT(29)
#define DWC31_TXTHRNUMPKT_PRD(n)		(((n) & 0x1f) << 24)
#define DWC31_MAXTXBURSTSIZE_PRD(n)		(((n) & 0x1f) << 19)
